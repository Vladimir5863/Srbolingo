...
class PracticeModeTwoOptionsActivity : AppCompatActivity() {
    ...
    private fun showQuestion() {
        try {
            ...
            // For level 3, we only show 2 options
    ...
    private fun showResults() {
        binding.apply {
            ...
            finishButton.setOnClickListener {
                try {
                    val intent = Intent(this@PracticeModeTwoOptionsActivity, TestReviewActivity::class.java).apply {
                    ...
                    Log.e("PracticeModeTwoOptionsActivity", "Error starting review", e)
                    Toast.makeText(
                        this@PracticeModeTwoOptionsActivity,
